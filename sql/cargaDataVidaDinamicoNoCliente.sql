...
begin
    ...
    LOOP
        ...
        INSERT INTO PISD.T_PISD_INSURANCE_CONTRACT
              ...
              VALUES(entity                      , branch_id                   , account                      , '7'                          , '6'                           , 9                   ,'0814000005471'+i        , '02'                  , 1                   , '1300029302' + i, 'P029999'           , 'P029999'            , branch_id                 , ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),0), ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),0), ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),12), 12                           , ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),12), '90008603' , '00110486840190021967', 'N'                   , 1                    , 1                   , 50.00         , premium*12                   , 'PEN'      , ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),12), ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),12) , 20000.00      , '08'            , 0             , 'PC'                       , ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),1), 'N'                     , 'PEN'                         , 'FOR'             , 'P029801'       , TO_DATE(sysdate,'DD/MM/YYYY'), 'P029801'    , TO_DATE(sysdate,'DD/MM/YYYY'), 'S'                        , 0                , 999.00                     , 0                            , 600.00                       , '8046'                      , 'N'                           , '923123'                );
        FOR j IN 1..1
        LOOP
