...
begin
    ...
    FOR i IN 1..5
    LOOP
        account := LPAD(414000074+i*100,10,'0');
        premium := 384;
        INSERT INTO PISD.T_PISD_INSURANCE_CONTRACT
              ...
              VALUES(entity                      , branch_id                   , account                      , '7'                          , '6'                           , 13                  , '01'                  , 1                   , NULL            , 'P029999'           , 'P029999'            , branch_id                 , ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),0), ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),0), ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),12), 12                           , ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),12), '02119676' , '00110486840190021967', 'N'                   , 1                    , 1                   , premium         , premium                    , 'PEN'      , ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),12), ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),12) , 10000.00      , '08'            , 0             , 'PC'                       , ADD_MONTHS(to_Date(my_date,'DD/MM/YYYY'),12), 'N'                     , 'PEN'                            , 'PEN'             , 'P029801'       , TO_DATE(sysdate,'DD/MM/YYYY'), 'P029801'    , TO_DATE(sysdate,'DD/MM/YYYY'), 'S'                        , 0                , 999.00                     , 0                            , 600.00                       , NULL                        , 'N'                           , '923123'                );
        FOR j IN 1..1
        LOOP
