...
DECLARE
   ...
   previous_product_id NUMBER(4,0);
...
BEGIN
   ...
   --SELECT MAX(INSURANCE_PRODUCT_ID) + 1 into next_last_product_id  FROM PISD.T_PISD_INSURANCE_PRODUCT;
    ...
    previous_product_id := 21;
   --DELETE FROM PISD.T_PISD_INSURANCE_PRODUCT where INSURANCE_PRODUCT_ID=next_last_product_id;
    UPDATE PISD.T_PISD_INSURANCE_CONTRACT SET INSURANCE_PRODUCT_ID = next_last_product_id
     WHERE INSURANCE_PRODUCT_ID = previous_product_id;

    delete from PISD.T_PISD_INSRNC_SIMLT_PRD  WHERE INSURANCE_PRODUCT_ID = previous_product_id;
    delete from PISD.T_PISD_INSRNC_QUOTATION_MOD  WHERE INSURANCE_PRODUCT_ID = previous_product_id;

    delete from PISD.T_PISD_INSRNC_ROLE_MODALITY where INSURANCE_PRODUCT_ID = previous_product_id;
    delete from PISD.T_PISD_INSRNC_ROLE_MODALITY where INSURANCE_PRODUCT_ID = next_last_product_id;

  delete from PISD.T_PISD_SCHAN_INSRNC_MOD_FEE where INSURANCE_PRODUCT_ID = previous_product_id;
     delete from PISD.T_PISD_SCHAN_INSRNC_MOD_FEE where INSURANCE_PRODUCT_ID = next_last_product_id;

     delete from PISD.T_PISD_INSURANCE_MOD_SCHAN where INSURANCE_PRODUCT_ID = previous_product_id;
    delete from PISD.T_PISD_INSURANCE_MOD_SCHAN where INSURANCE_PRODUCT_ID = next_last_product_id;

    delete from PISD.T_PISD_INSRNC_PRD_MODALITY where INSURANCE_PRODUCT_ID = previous_product_id;
    delete from PISD.T_PISD_INSRNC_PRD_MODALITY where INSURANCE_PRODUCT_ID = next_last_product_id;
  ...
  WHERE INSURANCE_PRODUCT_ID = next_last_product_id;
  ...
  WHERE INSURANCE_PRODUCT_ID = previous_product_id;
   ...
   -- INSERT INTO PISD.T_PISD_INSURANCE_PRODUCT (INSURANCE_PRODUCT_ID ,INSURANCE_RISK_BUSINESS_ID,INSURANCE_TYPE_ID,INSURANCE_PRODUCT_DESC                   ,INSURANCE_PRODUCT_NAME,INSURANCE_PRODUCT_TYPE,GIFT_PRODUCT_TYPE,SIMLT_VALIDITY_DAYS_NUMBER,COLLECTIVE_POLICY_TYPE,ATTEMPT_CLCT_INSRC_CNCL_TYPE,CHARGE_ATTEMPTS_NUMBER,JOINT_IND_TYPE,BILLING_RATE_CHANGE_IND_TYPE,DEFERRED_ENTRY_IND_TYPE,HEALTH_EVAL_MARK_TYPE,REGISTRY_SITUATION_TYPE,CREATION_USER_ID,CREATION_DATE,USER_AUDIT_ID,AUDIT_DATE     , PRODUCT_SHORT_DESC)
    ...
    INSERT INTO PISD.T_PISD_INSRNC_PRD_MODALITY (INSURANCE_PRODUCT_ID   ,INSURANCE_MODALITY_TYPE,INSURANCE_COMPANY_ID,INSURANCE_COMPANY_MODALITY_ID,CURRENCY_ID,INSUR_MODALITY_DESC ,INSURANCE_MODALITY_NAME,OPERATION_GLOSSARY_DESC,INSRNC_MOD_VLDY_START_DATE            ,INSRNC_MODALITY_VLDY_END_DATE          ,CUMULUS_MARK_TYPE,CUMULUS_CLAUSE_ID,INSURANCE_EXPIRATION_TYPE,CONTRACT_DURATION_TYPE,CONTRACT_DURATION_NUMBER,INSRNC_MODALITY_MIN_PDS_NUMBER,INSRNC_MODALITY_MAX_PDS_NUMBER,QUOTA_VALIDITY_DAYS_NUMBER,INSRNC_ANNUL_DAYS_MAX_NUMBER,SUGGESTED_MODALITY_IND_TYPE,REGISTRY_SITUATION_TYPE,CREATION_USER_ID,CREATION_DATE   ,USER_AUDIT_ID,AUDIT_DATE     ,INSURANCE_COMPANY_CONTRACT_ID)
                                         VALUES (next_last_product_id   ,modality_plan1                   ,1                   ,'533611'                     ,'PEN'      ,'PLAN 01 VIDA DIN'  ,'PLAN 1'             ,'SEG. VD 01'           ,TO_DATE('04/07/2023','DD/MM/YYYY')    ,TO_DATE('31/12/9999','DD/MM/YYYY')     ,'S'              ,NULL             ,' '                      ,' '                   ,999                     ,1                             ,999                           ,30                        ,90                          ,' '                        ,'01'                   ,'BATCH'         ,SYSTIMESTAMP    ,'BATCH'      ,SYSTIMESTAMP   ,'00110486840190021967');

    INSERT INTO PISD.T_PISD_INSRNC_PRD_MODALITY (INSURANCE_PRODUCT_ID   ,INSURANCE_MODALITY_TYPE,INSURANCE_COMPANY_ID,INSURANCE_COMPANY_MODALITY_ID,CURRENCY_ID,INSUR_MODALITY_DESC    ,INSURANCE_MODALITY_NAME,OPERATION_GLOSSARY_DESC,INSRNC_MOD_VLDY_START_DATE             ,INSRNC_MODALITY_VLDY_END_DATE          ,CUMULUS_MARK_TYPE,CUMULUS_CLAUSE_ID,INSURANCE_EXPIRATION_TYPE,CONTRACT_DURATION_TYPE,CONTRACT_DURATION_NUMBER,INSRNC_MODALITY_MIN_PDS_NUMBER,INSRNC_MODALITY_MAX_PDS_NUMBER,QUOTA_VALIDITY_DAYS_NUMBER,INSRNC_ANNUL_DAYS_MAX_NUMBER,SUGGESTED_MODALITY_IND_TYPE,REGISTRY_SITUATION_TYPE,CREATION_USER_ID,CREATION_DATE ,USER_AUDIT_ID  ,AUDIT_DATE  ,INSURANCE_COMPANY_CONTRACT_ID)
                                         VALUES (next_last_product_id   ,modality_plan2                   ,1                   ,'533612'                     ,'PEN'      ,'PLAN 02 VIDA DIN'     ,'PLAN 2'             ,'SEG. VD 02'           ,TO_DATE('04/07/2023','DD/MM/YYYY')     ,TO_DATE('31/12/9999','DD/MM/YYYY')     ,'S'              ,NULL             ,' '                      ,' '                   ,999                     ,1                             ,999                           ,30                        ,90                          ,' '                        ,'01'                   ,'BATCH'         ,SYSTIMESTAMP  ,'BATCH'        ,SYSTIMESTAMP,'00110486840190021967');
    ...
    -- comisiones
    -- UPDATE PISD.T_PISD_SCHAN_INSRNC_MOD_FEE SET INSURANCE_PRODUCT_ID = next_last_product_id WHERE INSURANCE_PRODUCT_ID = previous_product_id;
   ...
   -- UPDATE PISD.T_PISD_INSRNC_SIMLT_PRD SET INSURANCE_PRODUCT_ID = next_last_product_id WHERE INSURANCE_PRODUCT_ID = previous_product_id;
